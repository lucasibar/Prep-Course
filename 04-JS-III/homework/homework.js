...
function multiplicarArgumentos() {
  ...
  // Si no se pasan argumentos devuelve 0. Si se pasa un 
  //argumento, simplemente devuélvelo
...
function diaDeLaSemana(numeroDeDia) {
  ...
  //Realiza una función que dado el número del día de la 
  //semana, retorne: Es fin de semana
  //si el día corresponde a Sábado o Doming o y “Es dia 
...
function mesesDelAño(array) {
  ...
  // "Enero", "Marzo" y "Noviembre", guardarlo en nuevo 
  //array y retornarlo.
  //Si alguno de los meses no está, devolver: "No se 
  //encontraron los meses pedidos"
  // Tu código:
...
function mayorACien(array) {
  ...
  //valores mayores a 100 (no incluye el 100). Finalmente 
...
function breakStatement(numero) {
  ...
  //de iteraciones coinciden, debe interrumpirse la 
  //ejecución y 
...
function continueStatement(numero) {
  ...
  //no se suma en ese caso y se continua con la siguiente
  // iteración
